export function ProductModal({ product, onClose }) {
  ...
  return (
    // use a valid Tailwind z-index class; z-60 isn't generated by default and
    // without a defined z-index the fixed overlay can slip behind transformed cards.
    // z-50 is the highest built-in value, which keeps the modal on top.
